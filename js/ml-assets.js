...
var mlAssets = [
{
    "Name": "Advanced Deep Learning & Reinforcement Learning - Assignments of UCL Course",
    "Description": "Assignments for the UCL course by the same name.",
    "Link": "https://github.com/KonkimallaChandraPrakash/ADL_RL",
    "Keywords": "assignments,reading,course,UCL,class,education,deep learning,reinforcement learning,",
    "LastUpdatedDate": "2019/1/23",
},
{
    "Name": "Advanced Deep Learning & Reinforcement Learning - Video Slides of UCL Course",
    "Description": "Slides for the UCL course by the same name.",
    "Link": "https://github.com/enggen/DeepMind-Advanced-Deep-Learning-and-Reinforcement-Learning",
    "Keywords": "slides,reading,course,UCL,class,education,deep learning,reinforcement learning,",
    "LastUpdatedDate": "2019/1/23",
},
{
    "Name": "Advanced Deep Learning & Reinforcement Learning - Video Recording of UCL Course",
    "Description": "This course, taught originally at UCL and recorded for online access, has two interleaved parts that converge towards the end of the course. One part is on machine learning with deep neural networks, the other part is about prediction and control using reinforcement learning. The two strands come together when we discuss deep reinforcement learning, where deep neural networks are trained as function approximators in a reinforcement learning setting.  The deep learning stream of the course will cover a short introduction to neural networks and supervised learning with TensorFlow, followed by lectures on convolutional neural networks, recurrent neural networks, end-to-end and energy-based learning, optimization methods, unsupervised learning as well as attention and memory. Possible applications areas to be discussed include object recognition and natural language processing.",
    "Link": "https://www.youtube.com/playlist?list=PLqYmG7hTraZDNJre23vqCGIVpfZ_K2RZs",
    "Keywords": "videos,course,UCL,class,education,deep learning,reinforcement learning,",
    "LastUpdatedDate": "2019/1/23",
},
{
    "Name": "MXNet Gluon Model Zoo - Sentiment Analysis",
    "Description": "This script can be used to train a sentiment analysis model from scratch, or fine-tune a pre-trained language model. The pre-trained language models are loaded from Gluon NLP Toolkit model zoo. It also showcases how to use different bucketing strategies to speed up training.",
    "Link": "http://gluon-nlp.mxnet.io/model_zoo/sentiment_analysis/index.html",
    "Keywords": "MXNet,Gluon,sentiment analysis,examples,cnn,text classifier,convolutional neural network",
    "LastUpdatedDate": "2019/1/23",
},
{
    "Name": "Hamiltonian Monte Carlo explained",
    "Description": "MCMC (Markov chain Monte Carlo) is a family of methods that are applied in computational physics and chemistry and also widely used in bayesian machine learning.",
    "Link": "http://arogozhnikov.github.io/2016/12/19/markov_chain_monte_carlo.html",
    "Keywords": "reading,blog,markov chain,monte carlo,Bayes",
    "LastUpdatedDate": "2019/1/23",
},
{
    "Name": "CS228 Notes on Probabilistic Graphical Models (PGMs)",
    "Description": "These notes form a concise introductory course on probabilistic graphical modelsProbabilistic graphical models are a subfield of machine learning that studies how to describe and reason about the world in terms of probabilities.. They are based on Stanford CS228, and are written by Volodymyr Kuleshov and Stefano Ermon, with the help of many students and course staff. This course starts by introducing probabilistic graphical models from the very basics and concludes by explaining from first principles the variational auto-encoder, an important probabilistic model that is also one of the most influential recent results in deep learning.",
    "Link": "https://ermongroup.github.io/cs228-notes/",
    "Keywords": "PGMs,Probabilistic Graphical Models,reading,class notes,course notes,Stanford",
    "LastUpdatedDate": "2019/1/23",
},
{
    "Name": "Kotlin Data Science Resources",
    "Description": "Curation of libraries, media, links, and other resources to use Kotlin for data science",
    "Link": "https://github.com/thomasnield/kotlin-data-science-resources",
    "Keywords": "Kotlin,repos,reading,examples,libraries,PGMs,Probabilistic Graphical Models",
    "LastUpdatedDate": "2019/1/23",
},
{
    "Name": "bayesian-net-project",
    "Description": "A project for the exam AI Lab at Università di Torino. This project gives implementations of Bayesian Networks and Dynamic Bayesian Networks, in Kotlin.",
    "Link": "https://github.com/lamba92/bayesian-net-project",
    "Keywords": "Kotlin,PGMs,Probabilistic Graphical Models,Bayes,repos,examples",
    "LastUpdatedDate": "2019/1/23",
},
{
    "Name": "kotlin-statistics",
    "Description": "Idiomatic statistical operators for Kotlin. This library contains helpful extension functions to perform exploratory and production statistics in a Kotlin-idiomatic way.",
    "Link": "https://github.com/thomasnield/kotlin-statistics",
    "Keywords": "Kotlin,statistics,library,PGMs,Probabilistic Graphical Models",
    "LastUpdatedDate": "2019/1/23",
},
{
    "Name": "krangl",
    "Description": "krangl is a {K}otlin DSL for data w{rangl}ing. This is often cited as being used in Kotlin the same way Pandas is used in Python.",
    "Link": "https://github.com/holgerbrandl/krangl",
    "Keywords": "Kotlin,Pandas,Dataframes,library",
    "LastUpdatedDate": "2019/1/23",
},
{
    "Name": "Music Transformer: Generating Music with Long-Term Structure",
    "Description": "Generating long pieces of music is a challenging problem, as music contains structure at multiple timescales, from milisecond timings to motifs to phrases to repetition of entire sections. We present Music Transformer, an attention-based neural network that can generate music with improved long-term coherence.",
    "Link": "https://magenta.tensorflow.org/music-transformer",
    "Keywords": "music,examples,blog,reading,research,Magenta,Google,Tensorflow,Wavenet,audio",
    "LastUpdatedDate": "2019/1/23",
},
{
